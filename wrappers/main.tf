module "wrapper" {
  ...
  autoscaling_scheduled_read            = try(each.value.autoscaling_scheduled_read, var.defaults.autoscaling_scheduled_read, [])
  autoscaling_scheduled_write           = try(each.value.autoscaling_scheduled_write, var.defaults.autoscaling_scheduled_write, [])
  autoscaling_scheduled_indexes_read    = try(each.value.autoscaling_scheduled_indexes_read, var.defaults.autoscaling_scheduled_indexes_read, {})
  autoscaling_scheduled_indexes_write   = try(each.value.autoscaling_scheduled_indexes_write, var.defaults.autoscaling_scheduled_indexes_write, {})
