module "wrapper" {
  ...
  autoscaling_scaling_read              = try(each.value.autoscaling_scaling_read, var.defaults.autoscaling_scaling_read, [])
  autoscaling_scaling_write             = try(each.value.autoscaling_scaling_write, var.defaults.autoscaling_scaling_write, [])
  autoscaling_scaling_indexes_read      = try(each.value.autoscaling_scaling_indexes_read, var.defaults.autoscaling_scaling_indexes_read, {})
  autoscaling_scaling_indexes_write     = try(each.value.autoscaling_scaling_indexes_write, var.defaults.autoscaling_scaling_indexes_write, {})
