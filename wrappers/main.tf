module "wrapper" {
  ...
  autoscaling_indexes                   = try(each.value.autoscaling_indexes, var.defaults.autoscaling_indexes, null)
  autoscaling_read                      = try(each.value.autoscaling_read, var.defaults.autoscaling_read, null)
  autoscaling_write                     = try(each.value.autoscaling_write, var.defaults.autoscaling_write, null)
  ...
  replicas                              = try(each.value.replicas, var.defaults.replicas, null)
